...
* During the 60th cycle, register `X` has the value `19`, so the signal strength is 60 * 19 = `<em>1140</em>`.
* During the 100th cycle, register `X` has the value `18`, so the signal strength is 100 * 18 = `<em>1800</em>`.
* During the 140th cycle, register `X` has the value `21`, so the signal strength is 140 * 21 = `<em>2940</em>`.
* During the 180th cycle, register `X` has the value `16`, so the signal strength is 180 * 16 = `<em>2880</em>`.
* During the 220th cycle, register `X` has the value `18`, so the signal strength is 220 * 18 = `<em>3960</em>`.

The sum of these signal strengths is `<em>13140</em>`.
