...
Truly incredible - now the small details are really starting to come through. After enhancing the original input image twice, `<em>35</em>` pixels are lit.
...
If you enhance the starting input image in the above example a total of _50_ times, `<em>3351</em>` pixels are lit in the final output image.
