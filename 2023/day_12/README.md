...
* `.??..??...?##. 1,1,3` -`<em>4</em>` arrangements
* `?#?#?#?#?#?#?#? 1,3,1,6` -`<em>1</em>` arrangement
* `????.#...#... 4,1,1` -`<em>1</em>` arrangement
* `????.######..#####. 1,6,5` -`<em>4</em>` arrangements
* `?###???????? 3,2,1` -`<em>10</em>` arrangements

Adding all of the possible arrangement counts together produces a total of `<em>21</em>` arrangements.
