...
This hike contains `<em>94</em>` steps. (The other possible hikes you could have taken were `90`, `86`, `82`, `82`, and `74` steps long.)
...
In the example above, this increases the longest hike to `<em>154</em>` steps:
