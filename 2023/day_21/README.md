...
In this example, if the Elf's goal was to get exactly `6` more steps today, he could use them to reach any of `<em>16</em>` garden plots.
...
The _actual_ number of steps he needs to get today is exactly `<em>26501365</em>`.
...
* In exactly `6` steps, he can still reach `<em>16</em>` garden plots.
* In exactly `10` steps, he can reach any of `<em>50</em>` garden plots.
* In exactly `50` steps, he can reach `<em>1594</em>` garden plots.
* In exactly `100` steps, he can reach `<em>6536</em>` garden plots.
* In exactly `500` steps, he can reach `<em>167004</em>` garden plots.
* In exactly `1000` steps, he can reach `<em>668697</em>` garden plots.
* In exactly `5000` steps, he can reach `<em>16733044</em>` garden plots.
