...
So, in this example, `<em>2</em>` hailstones' future paths cross inside the boundaries of the test area.
...
So, at time `0`, the rock needs to be at X position `24`, Y position `13`, and Z position `10`. Adding these three coordinates together produces `<em>47</em>`. (Don't add any coordinates from the rock's velocity.)
