...
The total load is the sum of the load caused by all of the _rounded rocks_. In this example, the total load is `<em>136</em>`.
...
In the above example, after `1000000000` cycles, the total load on the north support beams is `<em>64</em>`.
